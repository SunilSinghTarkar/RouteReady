...
public class CabServiceImpl implements CabService{
    ...
    public Cab updateCab(Cab cab) {
        ...
        // checking for cab exists or not;
         Cab existingCab= cabRepository.findById(cab.getCabId()).orElseThrow(()-> new RouteReadyException("Cab with id: "+cab.getCabId()+" does not exist "));
    ...
    public Cab deleteCab(Integer cabId) {
        ...
        // checking for cab exists or not;
        Cab deletingCab= cabRepository.findById(cabId).orElseThrow(()-> new RouteReadyException("Cab with id: "+cabId+" does not exist "));
    ...
    public List<Cab> viewCabsOfType(String carType) {
        ...
        if(cabs.isEmpty()) throw new RouteReadyException("No cab found of type "+carType);
