...
public class CustomerUserDetailsService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		Optional<Driver> dvr= driverRepository.findByUserName(username);
		...
		if(opt.isPresent()) {
		...
		else if(dvr.isPresent()) {
			
			Driver driver= dvr.get();
			...
			return new User(driver.getUserName(), driver.getPassword(), authorities);
